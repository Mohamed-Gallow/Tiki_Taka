<%@ Page Language="C#" AutoEventWireup="true" UnobtrusiveValidationMode="none" CodeBehind="foot.aspx.cs" Inherits="Tiki_Taka.foot" %>
        ...
        <div class="form">
            <div class="title_of_detail">
               <!-- <input class="court_title" type="text" value="SPORTING COURT" readonly>
                ...
                <asp:TextBox ID="TextBox3" class="price_court" runat="server" ReadOnly></asp:TextBox>
            </div>
            <div class="address">
            ...
            <div class="btn">
                <asp:Button ID="Button1" runat="server" class="button" Text="Reserve" OnClick="Button1_Click" />
