<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage.Master" AutoEventWireup="true" UnobtrusiveValidationMode="none" CodeBehind="soccer.aspx.cs" Inherits="Tiki_Taka.soccer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Css_Link" runat="server">
    <link rel="stylesheet" href="css/soccer_stylee.css">
</asp:Content>
            ...
            <nav>
                <ul class="navigation">
                    ...
                    <li class="menu">
                        ...
                        <ul class="sub_menu">
                            <li><a href="soccer.aspx" class="game_active">Soccer</a></li>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Body_place" runat="server">
    <section class="main">
        <div>
            ...
            <h3 data-aos="fade-up">We make Soccer more fun</h3>
    ...
    <section class="courts" id="courts">
        <h2 data-aos="fade-up" class="title">Courts</h2>
        <div class="content">
            ...
            <div class="card" data-aos="flip-up">
                ...
                <div class="project-info">
                    ...
                    <strong class="project-title">
                        <span><%#Eval("name") %></span>
                       <asp:Button ID="Button1" runat="server" Text="Reserve" class="book" CommandArgument='<%# Eval("id") %>' CommandName="soccerid" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Tiki_TakaConnectionString %>" SelectCommand="SELECT * FROM [soccer]"></asp:SqlDataSource>
    ...
    <section class="bools services" id="services">
        ...
        <div class="content">
            <div class="card" data-aos="fade-up-edit">
                <div class="project-image">
                    <img src="images/photos_soccer_page/tennis.jpg">
                </div>
                <div class="project-info">
                    <p class="project-category">Reserve your tennis field</p>
                    <strong class="project-title">
                        <span>tennis</span>
            ...
            <div class="card" data-aos="fade-up-edit">
                <div class="project-image">
                    <img src="images/photos_soccer_page/basket.jpg">
                </div>
                <div class="project-info">
            ...
            <div class="card" data-aos="fade-up-edit">
                <div class="project-image">
                    <img src="images/photos_soccer_page/swimmer.jpg">
                </div>
                <div class="project-info">
